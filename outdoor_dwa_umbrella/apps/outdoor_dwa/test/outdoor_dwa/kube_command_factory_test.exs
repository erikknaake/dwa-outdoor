defmodule OutdoorDwa.KubeCommandFactoryTest do
  ...
  describe "commands" do
    ...
    test "should support namespace option" do
      ...
      assert cmd == "kubectl get endpoints -o=jsonpath='{.subsets[*].addresses[*].ip}' -n outdoor-dwa"
    end
  end
  ...
  describe "nested commands" do
    test "should allow piping multiple commands" do
      ...
      assert cmd == "kubectl get endpoints outdoor-dwa-svc -n outdoor-dwa | xargs -I % kubectl get pods --field-selector=status.podIP=% -n outdoor-dwa"
    end
    ...
    test "should support custom pipe" do
      ...
      assert cmd == "kubectl get endpoints outdoor-dwa-svc -n outdoor-dwa -o=jsonpath='{.subsets[*].addresses[*].ip}' | tr ' ' '\n' | xargs -I % kubectl get pods -o=jsonpath='{.items[*].status.podIP}' --field-selector=status.podIP=% -n outdoor-dwa"
    end
  end
end
